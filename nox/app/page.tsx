  ...
  return (
    <main className="nox-shell">
      ...
      <header className="nox-header">
        ...
        <Badge variant="cyan" icon={<span className="status-dot" aria-hidden="true" />} label="NEON VOID // ONLINE" />
      </header>
      ...
      >
        ...
        <Button label="PLAY NOW ↗" variant="primary" size="lg" onClick={scrollToHow} />
